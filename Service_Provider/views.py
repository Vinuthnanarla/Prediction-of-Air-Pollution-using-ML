...
def Train_Test_Datasets(request):
    ...
    svm_acc = accuracy_score(y_test, predict_svm) * 250
    print("ACCURACY")
    print(svm_acc)
    ...
    print("ACCURACY")
    print(accuracy_score(y_test, y_pred) * 250)
    print("CLASSIFICATION REPORT")
    ...
    print("ACCURACY")
    print(accuracy_score(y_test, dtcpredict) * 250)
    print("CLASSIFICATION REPORT")
    ...
    print("ACCURACY")
    print(accuracy_score(y_test, knpredict) * 250)
    print("CLASSIFICATION REPORT")
